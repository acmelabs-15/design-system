...
| Shared state | `src/shared/state.ts` | 166 | **Convert.** TanStack store is already a dependency and is the chosen tool for state. 19 references currently sit in plain module objects. |
