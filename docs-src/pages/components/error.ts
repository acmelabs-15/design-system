...
export const doc: Doc = {
  id: "error",
  title: "Error",
  lede: "A good error is clear, useful and friendly. A short, accurate message unblocks the user and builds trust by meeting people where they are.",
  tags: ["acme-error"],
  examples: [
    {
      h: "Default",
    ...
    {
      h: "Sizes",
      html: `<div class="row-md" style="gap:24px;align-items:stretch"><acme-error size="small">This email is in use.</acme-error><acme-error>This email is in use.</acme-error><acme-error size="large">This email is in use.</acme-error></div>`,
    },
    {
      h: "With an error property",
      html: `<acme-error error='{"message":"The request failed.","action":"Contact Us","link":"https://vercel.com/contact"}'></acme-error>`,
    },
  ],
  practices: {
    "When to use": [
    ...
    Accessibility: ['When the error appears after a failed fetch, wrap the region in aria-live="polite" so it is announced. Keep aria-live="assertive" for a blocking error that interrupts input.'],
  },
};
