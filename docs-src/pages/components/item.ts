...
export const doc: Doc = {
  ...
  examples: [
    {
      h: "Rows",
      html: `<acme-items boxed><acme-item amount="−$1,200.00"><acme-ricon slot="lead" hue="blue"><svg class="ic" aria-hidden="true"><use href="#i-card"/></svg></acme-ricon>Rent<span slot="meta">Sep 1 · Housing</span></acme-item><acme-item amount="+$8,400.00"><acme-ricon slot="lead" hue="green"><svg class="ic" aria-hidden="true"><use href="#i-dollar"/></svg></acme-ricon>Severance<span slot="meta">Sep 5 · Income</span><acme-tags slot="tags"><acme-tag>net</acme-tag></acme-tags></acme-item><acme-item href="#" amount="−$62.10"><acme-ricon slot="lead" hue="amber"><svg class="ic" aria-hidden="true"><use href="#i-wifi"/></svg></acme-ricon>Internet<span slot="meta">Sep 8 · Utilities</span><acme-button slot="actions" size="small" variant="tertiary">Edit</acme-button></acme-item></acme-items>`,
    },
    {
