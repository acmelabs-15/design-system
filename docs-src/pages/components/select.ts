...
export const doc: Doc = {
  ...
  examples: [
    ...
    },
    {
      h: "Prefix and suffix",
      html: row([
        `<acme-select aria-label="Small" placeholder="Small" size="small">${up("prefix")}${up("suffix")}</acme-select>`,
        `<acme-select aria-label="Default" placeholder="Default">${up("prefix")}${up("suffix")}</acme-select>`,
        `<acme-select aria-label="Large" placeholder="Large" size="large">${up("prefix")}${up("suffix")}</acme-select>`,
      ]),
    },
    {
      h: "Disabled",
    ...
    },
    {
      ...
      html: `<acme-select aria-label="Disabled" disabled placeholder="Disabled with prefix">${up("prefix")}</acme-select>`,
    },
    {
      h: "Placeholder selected", census: true,
    ...
    {
      h: "No suffix", census: true,
      p: '<code>suffix="false"</code> drops the chevron cell; the field keeps its right padding.',
      html: `<acme-select aria-label="No suffix" placeholder="No suffix" suffix="false"></acme-select>`,
    },
    {
      h: "Label without casing", census: true,
