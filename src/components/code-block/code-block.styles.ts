...
export const codeBlockCss = css`
  .code-block :where(acme-button.floating)::part(button) {
    position: absolute;
    top: min(16%, 16px);
    right: 1rem;
    z-index: 1;
  ...
  .code-block :where(.bar) :where(.actions) :where(acme-button)::part(button) {
    width: 1.75rem;
    height: 1.75rem;
  ...
  .code-block :where(.bar) :where(.actions) :where(acme-button) svg {
    flex-shrink: 0;
  }
  .code-block :where(acme-button.floating) svg {
    flex-shrink: 0;
    color: var(--ds-gray-900) !important;
  }
  ...
  @media (hover: hover) {
    .code-block[data-hover] :where(acme-button.floating)::part(button) {
      opacity: 1;
    }
  }
  .code-block :where(acme-button.floating)::part(button):focus {
    opacity: 1;
  }
  .code-block :where(acme-button.floating)::part(button):disabled {
    background-color: var(--ds-gray-100);
  }
  .code-block :where(acme-button.floating)[aria-disabled="true"]::part(button) {
    background-color: var(--ds-gray-100);
  }
  .code-block :where(acme-button.floating)[data-hover]::part(button) {
    background-color: var(--ds-gray-100);
  }
  :where(:host([data-dark])) .code-block :where(acme-button.floating)[data-hover]::part(button) {
    background-color: var(--ds-gray-200);
  }
  .code-block :where(acme-button.floating)[data-hover]::part(button):disabled {
    background-color: var(--ds-gray-100);
  }
