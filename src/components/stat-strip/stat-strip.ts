...
import type { AcmeStripItem } from "../strip-item/strip-item.js";
import { statStripCss } from "./stat-strip.styles.js";
...
export class AcmeStatStrip extends AcmeElement {
  static styles = [sharedCss, statStripCss, badgeCss, css`:host{display:block} .stat-strip{margin:0} ::slotted(acme-strip-item){display:contents}`];
  @property() value = "";
  render() {
